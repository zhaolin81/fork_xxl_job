...
import com.xxl.job.admin.core.thread.JobStatusMonitorHelper;
...
public final class XxlJobDynamicScheduler implements ApplicationContextAware, InitializingBean {
    ...
    public void init() throws Exception {
        ...
        // admin monitor run
        JobStatusMonitorHelper.getInstance().start();
    }
    ...
    public void destroy(){
        ...
        // admin monitor stop
        JobStatusMonitorHelper.getInstance().toStop();
	...
	public static boolean rescheduleJob(String jobGroup, String jobName, String cronExpression) throws SchedulerException {
        ...
        //如果之前是暂停状态，则保持暂停
        //todo 先启用后暂停可能会有瞬时调度触发
        if(triggerState!=null && triggerState.equals(TriggerState.PAUSED)){
