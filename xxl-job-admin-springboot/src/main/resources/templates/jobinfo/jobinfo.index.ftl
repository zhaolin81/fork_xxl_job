...
<div class="wrapper">
	...
	<div class="content-wrapper">
	    ...
	    <section class="content">
	    	...
	    	<div class="row" id="operation_bar">
	    		<div class="col-xs-4">
	            ...
	            <div class="col-xs-1">
                    <button class="btn btn-block btn-success job_operate_all" _type="job_pause_all">暂停</button>
	            </div>
                <div class="col-xs-1">
                    <button class="btn btn-block btn-success job_operate_all" _type="job_resume_all">恢复</button>
                </div>
          	</div>
         	...
         	<div class="modal-body">
				<form class="form-horizontal form" role="form" >
					...
					<div class="form-group">
						...
						<div class="col-sm-4"><input type="text" class="form-control" name="alarmEmail" placeholder="请输入“报警邮件”，多个邮件地址逗号分隔" maxlength="255" ></div>
					</div>
