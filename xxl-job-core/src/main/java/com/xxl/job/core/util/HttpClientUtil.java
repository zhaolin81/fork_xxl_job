...
public class HttpClientUtil {
	 ...
	 * post request
	 */
	public static byte[] postRequest(String reqURL, byte[] date,ContentType contentType) throws Exception {
		...
		try {
			...
			// data
			if (date != null) {
				httpPost.setEntity(new ByteArrayEntity(date, contentType));
			}
			// do post
	...
	public static byte[] postRequest(String reqURL, byte[] date) throws Exception {
		return postRequest(reqURL,date,ContentType.DEFAULT_BINARY);
	}
	/**
